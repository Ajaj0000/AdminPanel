                    ...
                    <>
                        ...
                        >
                            <Tab.Screen
                                options={{
                                    headerShown: false,
                                    tabBarIcon: (({ focused }) => <Image source={focused ? IcDashboard : IcDashboard1}
                            ...
                            <Tab.Screen
                                ...
                                options={{
                                    headerShown: false,
                                    tabBarIcon: (({ focused }) => <Image source={focused ? IcCategory1 : IcCategory}
                                        style={{ width: 31, height: 31 }} />)
                                }}
                            ...
                            <Tab.Screen
                                ...
                                options={{
                                    headerShown: false,
                                    tabBarBadge: 3,
                                    tabBarIcon: (({ focused }) => <Image source={focused ? Icorder : Icorder1}
                                        style={{ width: 31, height: 31 }} />)
                                }}
